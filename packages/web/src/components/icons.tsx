...
interface IconProps {
  /** Square icon size in px (width == height). Default 20. */
  size?: number;
}

// Discord glyph — a solid fill icon (fill, not stroke). Story 2.6: takes an
// optional `color` (default `currentColor`, so the white login button is
// unaffected) so the login invite row can request brand blurple (#5865F2).
export function DiscordIcon({ size = 20, color = 'currentColor' }: IconProps & { color?: string }): ReactElement {
  return (
...
// Nav icons use a lighter stroke (1.8) than the UI icons (2), per the prototype.
export function SearchIcon({ size = 20 }: IconProps): ReactElement {
  return (
    <svg
      width={size}
      height={size}
...
export function DocsIcon({ size = 20 }: IconProps): ReactElement {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path d="M4 4h16v5H4z" />
      <path d="M4 13h16M4 18h10" />
    </svg>
  );
}

export function LockIcon({ size = 20 }: IconProps): ReactElement {
  return (
    <svg
      width={size}
      height={size}
...
export function LogoutIcon({ size = 20 }: IconProps): ReactElement {
  return (
    <svg
      width={size}
      height={size}
...
// Shown by the theme toggle when the dark theme is active (click -> go light).
...
// Shown by the theme toggle when the light theme is active (click -> go dark).
...
// "ver en Discord" affordance on a search result card (Story 4.3).
export function ExternalLinkIcon({ size = 13 }: IconProps): ReactElement {
  return (
    <svg
      width={size}
      height={size}
...
// Paper-plane glyph — the chat composer send button (Story 5.4, 17px).
export function SendIcon({ size = 20 }: IconProps): ReactElement {
  return (
    <svg
      width={size}
      height={size}
...
// Clock/history glyph — the chat header "historial" button (Story 5.3).
export function HistoryIcon({ size = 20 }: IconProps): ReactElement {
  return (
    <svg
      width={size}
      height={size}
...
// Plus glyph — the chat header "nueva conversación" button (Story 5.3).
...
// X glyph — the chat header "cerrar" button (Story 5.3).
